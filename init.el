...
(custom-set-variables
 ...
 '(package-selected-packages
   '(scratch treemacs-projectile treemacs-all-the-icons treemacs copilot-chat helm-projectile helm doom-modeline all-the-icons diff-hl cfn-mode swiper zenburn-theme f editorconfig s flycheck exec-path-from-shell projectile magit)))
(custom-set-faces
